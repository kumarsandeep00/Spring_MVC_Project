...
import com.demo.entity.Tutorial;
...
public class TutorialController {
    ...
    public String saveTutorial(Tutorial tutorial, RedirectAttributes
            redirectAttributes) {
        try {
    ...
    public String deleteTutorial(@PathVariable("id") Integer id, Model
